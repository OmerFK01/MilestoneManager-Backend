package com.getCert.milestoneManager.utility;
...
public class JWTTokenProvider {
	...
	public List<GrantedAuthority> getAuthorities(String token){
		...
		return stream(Arrays.stream(claims).spliterator(), false).map(SimpleGrantedAuthority::new).collect(Collectors.toList());
	}
